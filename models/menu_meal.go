...
type MenuMeal struct {
	...
	Menu        Menu      `json:"-" gorm:"foreignKey:MenuID;constraint:OnDelete:CASCADE;OnUpdate:CASCADE;"` // Reference to Menu
	Meal        Meal      `json:"-" gorm:"foreignKey:MealID;constraint:OnUpdate:CASCADE;"`                  // Reference to Meal
}
